...
import com.rubit.simplestreamplayer.player.DashRendererBuilder;
import com.rubit.simplestreamplayer.player.DemoPlayer;
import com.rubit.simplestreamplayer.player.ExtractorRendererBuilder;
import com.rubit.simplestreamplayer.player.HlsRendererBuilder;
import com.rubit.simplestreamplayer.player.SmoothStreamingRendererBuilder;
import com.rubit.simplestreamplayer.player.UnsupportedDrmException;
import com.rubit.simplestreamplayer.player.DemoPlayer.RendererBuilder;
import com.rubit.simplestreamplayer.utilties.DemoUtil;
import com.rubit.simplestreamplayer.utilties.EventLogger;
import com.rubit.simplestreamplayer.utilties.SmoothStreamingTestMediaDrmCallback;
import com.rubit.simplestreamplayer.utilties.WidevineTestMediaDrmCallback;

/**
 * An activity that plays media using {@link DemoPlayer}.
 */
public class VideoPlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
	...
	private RendererBuilder getRendererBuilder() {
		...
		case DemoUtil.TYPE_DASH:
			return new DashRendererBuilder(this, userAgent, contentUri.toString(), new WidevineTestMediaDrmCallback(
					contentId), debugTextView, audioCapabilities);
		...
		case DemoUtil.TYPE_TS:
			return new ExtractorRendererBuilder(this, userAgent, contentUri, debugTextView, new TsExtractor(0,
					audioCapabilities));
	...
	private float getCaptionFontSize() {
		...
		return Math.max(getResources().getDimension(R.dimen.subtitle_minimum_font_size), CAPTION_LINE_HEIGHT_RATIO
